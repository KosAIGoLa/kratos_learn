...
func wireApp(confServer *conf.Server, confData *conf.Data, registry *conf.Registry, logger log.Logger) (*kratos.App, func(), error) {
	...
	userAssetRepo := data.NewUserAssetRepo(dataData, logger)
	financeUsecase := biz.NewFinanceUsecase(rechargeRepo, withdrawalRepo, rabbitMQClient, incomeLogRepo, balanceLogRepo, checkInRepo, userAssetRepo, logger)
