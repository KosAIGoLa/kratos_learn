...
type Data_RabbitMQ struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Addr          string                 `protobuf:"bytes,1,opt,name=addr,proto3" json:"addr,omitempty"`                               // e.g., "amqp://guest:guest@localhost:5672/"
	Exchange      string                 `protobuf:"bytes,2,opt,name=exchange,proto3" json:"exchange,omitempty"`                       // default: "finance.exchange"
	Queue         string                 `protobuf:"bytes,3,opt,name=queue,proto3" json:"queue,omitempty"`                             // default: "withdrawal.queue"
	RoutingKey    string                 `protobuf:"bytes,4,opt,name=routing_key,json=routingKey,proto3" json:"routing_key,omitempty"` // default: "withdrawal"
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Data_RabbitMQ) GetExchange() string {
	if x != nil {
		return x.Exchange
	}
	return ""
...
func (x *Data_RabbitMQ) GetQueue() string {
	if x != nil {
		return x.Queue
	}
	return ""
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\fdial_timeout\x18\a \x01(\v2\x19.google.protobuf.DurationR\vdialTimeout\x1aq\n" +
	"\bRabbitMQ\x12\x12\n" +
	...
	"sampleRateB\x1cZ\x1afinance/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	10, // 9: kratos.api.Registry.etcd:type_name -> kratos.api.Registry.Etcd
	...
	11, // 15: kratos.api.Registry.Etcd.dial_timeout:type_name -> google.protobuf.Duration
