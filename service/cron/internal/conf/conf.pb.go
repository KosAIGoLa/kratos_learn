...
type Client struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Finance       *Client_Finance        `protobuf:"bytes,1,opt,name=finance,proto3" json:"finance,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Client) GetFinance() *Client_Finance {
	if x != nil {
		return x.Finance
	}
	return nil
...
func (x *Client_Finance) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Client_Finance) ProtoMessage() {}

func (x *Client_Finance) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Client_Finance.ProtoReflect.Descriptor instead.
func (*Client_Finance) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{1, 0}
}

func (x *Client_Finance) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
func (x *Client_Finance) GetTimeout() *durationpb.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\x06client\x18\x04 \x01(\v2\x12.kratos.api.ClientR\x06client\"\x9a\x01\n" +
	"\x06Client\x124\n" +
	"\afinance\x18\x01 \x01(\v2\x1a.kratos.api.Client.FinanceR\afinance\x1aZ\n" +
	"\aFinance\x12\x1a\n" +
	"\bendpoint\x18\x01 \x01(\tR\bendpoint\x123\n" +
	"\atimeout\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xb8\x02\n" +
	"\x06Server\x12+\n" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\"D\n" +
	"\x05Trace\x12\x1a\n" +
	"\bendpoint\x18\x01 \x01(\tR\bendpoint\x12\x1f\n" +
	"\vsample_rate\x18\x02 \x01(\x02R\n" +
	"sampleRateB\x19Z\x17cron/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Client_Finance)(nil),      // 5: kratos.api.Client.Finance
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	5,  // 4: kratos.api.Client.finance:type_name -> kratos.api.Client.Finance
	...
	10, // 9: kratos.api.Client.Finance.timeout:type_name -> google.protobuf.Duration
